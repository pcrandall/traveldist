...
// Navette holds a metadata and its notes
type Navette struct {
...
// NewNavette constructs a book with the given data
func NewNavette(uuid, label string, usn int, deleted, dirty bool) Navette {
	return Navette{
		UUID:    uuid,
		Label:   label,
		USN:     usn,
...
func (b Navette) Insert(db *DB) error {
...
func (b Navette) Update(db *DB) error {
...
// UpdateUUID updates the uuid of a book
func (b *Navette) UpdateUUID(db *DB, newUUID string) error {
...
func (b Navette) Expunge(db *DB) error {
